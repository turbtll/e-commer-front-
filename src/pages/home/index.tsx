 ...
 const Home = () => {
  ...
  return (
    <section className="relative">
           <img
        className="absolute min-h-screen  object-cover -top-[120px] -z-10 "
    ...
    <div className="mx-[50px] min-h-screen border-4 flex flex-col justify-end items-start
     pb-40">
      ...
      {products.slice(0,3).map((e)=>{
        return(
          ...
          <img width={368} height={368} className="w-[368px] h-[368px] rounded-[18px]"  src={e.image} alt={e.name} />
          </div>
            <Button className="mt-7"
            onClick={navigateToShop}>
              <span className="flex">
      ...
      <div className="mt-[180px] mx-[50px] max-w-3xl">
        <Text variant="heading-one">
          Test hoodies
        </Text>
        <Text variant="body-two" className="mt-7">
          Test hoodies Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto mollitia libero, ullam ducimus velit, non cupiditate fugiat unde consectetur dolores nulla, eum totam. Quas commodi ut suscipit culpa tenetur libero!
        </Text>
      </div>
