...
import Button from "../../components/button.tsx"
 ...
 <div className="grid grid-cols-2 mb-[180px] gap-10  mx-[50px]">
    <div className="">
        <img src={product?.image} alt={product?.name} className="aspect-[0.9] h-[619px]  object-cover rounded-3xl" />
    </div>
    <div className="">
        <Text variant="heading-one"> {product?.name}</Text>
        <Text variant="subheading-two" className="my-7"> ${product?.price}</Text>
        <Text variant="body-two"> {product?.description}</Text>
        <Button size="medium" className="mt-14"> ADD TO BAG</Button>
         </div>
